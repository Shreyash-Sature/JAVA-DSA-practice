error id: file://<WORKSPACE>/B_MaxElement.java
file://<WORKSPACE>/B_MaxElement.java
...
```java
offset: 0
uri: file://<WORKSPACE>/B_MaxElement.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/B_MaxElement.java